...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Book',
            fields=[
                ('isbn', models.CharField(max_length=255, primary_key=True, serialize=False, unique=True)),
                ('year', models.CharField(max_length=5)),
                ('title', models.CharField(max_length=100)),
                ('price', models.FloatField(max_length=19)),
                ('author_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='book_author', to='book_warehouse.author')),
                ('publisher_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='book_publisher', to='book_warehouse.publisher')),
            ],
        ),
        migrations.CreateModel(
            name='ShoppingBasket',
